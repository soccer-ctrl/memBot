...
/*
Task 1
In file chatgui.h / chatgui.cpp, _chatLogic is made an exclusive resource to class ChatbotPanelDialog using an appropriate smart pointer. 
Where required, changes are made to the code such that data structures and function parameters reflect the new structure.
*/
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    //// STUDENT CODE
    ////
    //NO need to specify delete here, as the smart pointer will take care of this
    //delete _chatLogic;
